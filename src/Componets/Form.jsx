...
const Form = ()=> {
    return(
            ...
            <div className="container pv2 br4 mh1 shadow-5">
                <form action="https://formspree.io/mvowzeqr" method="POST" style={{ display: 'flex', flexDirection: 'column',justifyContent: 'space-evenly',alignItems:'center'}}>
                ...
                <br/>
                <input style={{fontSize:'3vh'}} className='br2  tc  w-90 '  type="email" id="fname" name="email" placeholder="Email" required/><br/>
